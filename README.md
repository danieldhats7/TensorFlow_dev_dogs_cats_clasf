...
Este código fuente sirve como apoyo para el video de creación de un clasificador de perros y gatos usando Python y Tensorflow. Puedes ver su funcionamiento [aqui](https://danieldhats7.github.io/TensorFlow_dev_dogs_cats_clasf/)
